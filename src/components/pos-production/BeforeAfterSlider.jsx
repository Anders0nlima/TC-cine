...
const BeforeAfterSlider = ({ variant = 'full', customPairs }) => {
  const defaultPairs = [
    {
      id: 1,
      before: antes7, /*semEfeitoImg1*/
      after: depois7, /*comEfeitoImg1*/
      thumbnail: thumb4 /*comEfeitoImg1*/
    },
    {
      id: 2,
      before: antes8, /*semEfeitoImg1*/
      after: depois8, /*comEfeitoImg1*/
  ...
  const imagePairs = customPairs || defaultPairs;
  ...
  const handleDrag = (e) => {
    ...
    let posX = (e.clientX || (e.touches && e.touches[0]?.clientX)) - containerRect.left;
  ...
  const containerClass = `${styles.before_after_container} ${variant === 'sidebar' ? styles.sidebarVariant : ''}`;
